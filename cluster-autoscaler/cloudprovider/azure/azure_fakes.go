...
func (m *DeploymentsClientMock) Get(ctx context.Context, resourceGroupName, deploymentName string) (
...
func (m *DeploymentsClientMock) ExportTemplate(ctx context.Context, resourceGroupName, deploymentName string) (
...
func (m *DeploymentsClientMock) CreateOrUpdate(ctx context.Context, resourceGroupName string, deploymentName string,
...
func (m *DeploymentsClientMock) List(ctx context.Context, resourceGroupName, filter string, top *int32) (
	result []resources.DeploymentExtended, err error) {
	m.mutex.Lock()
	defer m.mutex.Unlock()
